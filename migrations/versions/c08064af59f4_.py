...
Revision ID: c08064af59f4
Revises: 614400321d73
Create Date: 2022-03-21 20:27:18.228029
...
revision = 'c08064af59f4'
down_revision = '614400321d73'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['company_id'], ['company.id'], ondelete='SET NULL', use_alter=True),
